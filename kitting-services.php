...
<body>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <img src="images/kitting-services-2.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6">
                <img src="images/Assembly.png" alt="">
            </div>
            <div class="col-12 col-lg-6">
                <article class="pe-5">
                    <div class="display-5 fw-bold">Efficient assembly</div>
                    <p class="lead py-3">There are multiple ways to prepare kits. We can either do all of them at once, or at time of order. Every business is different, so we adjust to your requirements.</p>
                </article>
            </div>
        </div>
    </div>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <img src="images/all_data.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6">
                <img src="images/Experts_20in_20Kitting.png" alt="">
            </div>
            <div class="col-12 col-lg-6">
                <article class="pe-5">
                    <div class="display-5 fw-bold">Delight your customers</div>
                    <p class="lead py-3">When your customer receives their order, they deserve a great experience. It's easy to tell the difference between poorly prepared kits, and those prepared by professionals.</p>
                </article>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="fw-bold">Kitting + Fulfillment made easy</h1>
                </div>
            </div>
            <div class="row pt-4">
                <div class="col-12 col-lg-6 cross-list">
                    ...
                    <ul>
                        <li>No kitting capabilities</li>
                        <li>Unorganized process flow</li>
                        <li>Spend hours explaining</li>
                    </ul>
                </div>
                <div class="col-12 col-lg-6 tick-list">
                    ...
                    <ul>
                        ...
                        <li>Regular updates while kitting</li>
                        <li>Kitting and fulfillment under 1 roof</li>
                        <li>Expertise in kitting</li>
                        <li>Ability to make modifications as needed</li>
