...
<body>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <img src="images/Section-321-1png.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <article class="pe-5">
                    <div class="display-5 fw-bold">Save Import Fees</div>
                    <p class="lead py-3">Depending on the category of products, you save up to 20% on tariffs.</p>                    
                </article>
            </div>
        </div>
    </div>
    ...
    <div class="container banner">
        <div class="row align-items-center">            
            <div class="col-12 col-lg-6">
                <article class="pe-5">
                    <div class="display-5 fw-bold">No Duties Paid By Customers</div>
                    <p class="lead py-3">If your product value is less than $800, your customers don't pay any duties.</p>                    
                </article>
            </div>
            <div class="col-12 col-lg-6">
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <article class="pe-5">
                    <div class="display-5 fw-bold">Low Shipping Cost</div>
                    <p class="lead py-3">We inject orders directly into the postal stream, which lowers yours cost with immediate impacts to your bottom line.</p>                    
                </article>
            </div>
        </div>
    </div>
