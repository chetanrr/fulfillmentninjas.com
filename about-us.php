...
<body>
    ...
    <div class="container banner">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <img src="images/About-us_Section.png" alt="">
            </div>
        </div>
    </div>
    ...
    <section class="bg-light">
        <div class="container text-center">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-4 fw-bold my-4 mb-5">Built for eCommerce Brands</h1>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-3 col-last">
                    <aside>
                        <h2>Proud to be a Sustainable Company</h2>                        
                    </aside>
                </div>
            </div>
        </div>
