...
<body>
    ...
    <div class="container banner text-center pb-0">
      <div class="row justify-content-center">
        <div class="col-9">
          <article class="pe-5">
            <h1>Our Clients</h1>
            <p class="lead text-primary">We onboard 5-10 brands every month.</p>
            <p class="lead">See profiles of accounts we've onboarded recently.</p>
          </article>
        </div>        
      </div>
    </div>
